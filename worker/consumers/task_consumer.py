...
from worker.services.generation_service import handle_generate_tasks
from worker.services.homework_check_service import handle_check_homework
...
async def process_task_message(task: dict) -> dict | None:
    ...
    try:
        ...
        if task_type == "generate_tasks":
            return await handle_generate_tasks(task)
